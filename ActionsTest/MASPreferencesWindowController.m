...
- (id)initWithViewControllers:(NSArray *)viewControllers title:(NSString *)title
{
    ...
    {
        _viewControllers = viewControllers; //  _viewControllers = [viewControllers retain];
...
- (void)windowWillClose:(NSNotification *)notification {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"preferecncesWillClose" object:self];
}
...
//        [_selectedViewController release];
    ...
    _selectedViewController = controller; //_selectedViewController = [controller retain];
